...
"""
PROJETO: EQUAÇÃO DO CALOR 1D (versão idealizada)
...
if r > 0.5:
    print("(não está estável) Calma, calma! Vai estabilizar! Vai estabilizar logo! BOOMM")
else:
    print("(está estável) O poder do sol... na palma da minha mão.")
